    ...
    export default {
        ...
        computed: {
            ...
            getTextColorClass() {
                ...
                return `text-blue-gray-gray-400 ${!this.disabled ? 'hover:text-blue-500 active:text-white' : ''}`;
            },
            ...
            getBorderColorClass() {
                ...
                return this.disabled ? 'border-blue-gray-gray-100' : 'border-blue-gray-gray-100 hover:border-blue-400';
            },
